...
async function run() {
  console.log("=== INICIANDO 10 PRUEBAS: INACCESIBILIDAD, PV 1, 500 FACTURAS ===");
  ...
  const pv = 1;
  const event = { motivo: 2, desc: 'INACCESIBILIDAD AL SERVICIO WEB' };
  let numFacturaGlobal = 900000;
